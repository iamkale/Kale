...
/**
 * Reads a player's save game data from the specified content bundle. The file must have already been
 * enumerated by ReadContentList as the friendly name is searched for in those results
 *
 ...
 */
function bool ReadSaveGameData(byte LocalUserNum,int DeviceId,string FriendlyName,string FileName);
 ...
 * @return true if the async read was started successfully, false otherwise
 */
function bool GetSaveGameData(byte LocalUserNum,int DeviceId,string FriendlyName,string FileName,out array<byte> SaveGameData);
 ...
 * @param FileName the file to read from inside of the content package
 */
delegate OnReadSaveGameDataComplete(bool bWasSuccessful,byte LocalUserNum,int DeviceId,string FriendlyName,string FileName);
 ...
 */
function bool WriteSaveGameData(byte LocalUserNum,int DeviceId,string FriendlyName,string FileName,const out array<byte> SaveGameData);
 ...
 * @param FileName the file to write to inside of the content package
 */
delegate OnWriteSaveGameDataComplete(bool bWasSuccessful,byte LocalUserNum,int DeviceId,string FriendlyName,string FileName);
 ...
 */
function bool DeleteSaveGameData(byte LocalUserNum,int DeviceId,string FriendlyName,string FileName);

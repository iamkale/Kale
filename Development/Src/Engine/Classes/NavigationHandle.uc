...
public:
	...
	void PathCache_Empty( FPathStore* PCache );
	void PathCache_AddEdge( FNavMeshEdgeBase* Edge, FPathStore* PCache = NULL  );
	void PathCache_InsertEdge( FNavMeshEdgeBase* Edge, int Idx=0, FPathStore* PCache = NULL  );
	void PathCache_RemoveEdge( FNavMeshEdgeBase* Edge, FPathStore* PCache = NULL  );
	void PathCache_RemoveIndex( int InIdx, int Count, FPathStore* PCache );

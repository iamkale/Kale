...
/** 
 * Texture that will be applied to the image based specular if bUseImageReflectionSpecular is TRUE.
 ...
 */
var(ImageReflection) Texture2D ReflectionTexture;

/** Scales the size of the image reflection, used if bUseImageReflectionSpecular is TRUE. */
var(ImageReflection) float ReflectionScale;

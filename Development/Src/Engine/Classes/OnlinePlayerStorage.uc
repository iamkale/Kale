...
public:
	 ...
	 */
	static void SetProfileSaveCount(INT NewCount,TArray<FOnlineProfileSetting>& ProfileSettings);
	 ...
	 */
	static INT GetProfileSaveCount(const TArray<FOnlineProfileSetting>& ProfileSettings);
}
